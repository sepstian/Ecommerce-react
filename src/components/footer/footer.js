...
import Logo from '../../assets/images/logo-tokopedia.jpg';
                ...
                <div className='container-fluid'>
                    <div className='box d-flex align-items-center'>
                        <div className='info'>
                            ...
                            <p>Start You'r Daily Shopping with Anjayy Mart</p>
                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-md-3 part1' >
                                ...
                                <p><LocationOnOutlinedIcon /> <strong>Address</strong>: East java, Indonesia</p>
                        ...
                        <div className='row lastStrip'>
                            <div className='col-md-3 part_1'>
                                <p>© 2025, Anjayy - HTML Ecommerce Template
                                ...
                                <div className='m-auto d-flex align-items-center phWrap'>
                                    <div className='phNo d-flex align-items-center mx-5'>
                                        ...
                                        <div className='info ml-3'>
                                            <h3 className='text-g mb-0'>19*** - ****</h3>
