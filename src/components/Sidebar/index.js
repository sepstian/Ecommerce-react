...
const Sidebar = (props) => {
    const [value, setValue] = useState([1000, 60000000]);
        ...
        <>
            <div className={`sidebar ${context.isOpenFilters===true && 'open'}`}>
                ...
                <div className='card border-0 shadow'>
                    ...
                    <RangeSlider value={value} onInput={setValue} min={1000} max={60000000} step={5} />


                    <div className='d-flex pt-2 pb-2 priceRange'>
                        <span>From: <strong className='text-success'>Rp: {formatRibuan(value[0])}</strong></span>
                        <span className='ml-auto'>From: <strong className='text-success'>Rp: {formatRibuan(value[1])}</strong></span>
                    </div>
