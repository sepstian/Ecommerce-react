                ...
                <div className='container detailsContainer pt-3 pb-3'>
                    <div className='row'>
                        ...
                        <div className='col-md-5'>
                            <div className='productZoom' style={{ backgroundColor:"" }}>
                        ...
                        <div className='col-md-7 productInfo'>
                            ...
                            <div className='priceSec d-flex align-items-center mb-3'>
                                <span className='text-g priceLarge'>Rp {formatRibuan(currentProduct.price)}</span>
                                <div className='ml-3 d-flex flex-column'>
                                    <span className='text-org'>{currentProduct.discount}% Off</span>
                                    <span className='text-light oldPrice'>Rp {formatRibuan(currentProduct.oldPrice)}</span>
                                </div>
                            </div>
