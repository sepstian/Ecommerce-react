...
import { delete_item, update_cart, update_quantity } from '../../redux/slice/cartSlice';
                        ...
                        <div className='col-md-8'>
                            <div className='d-flex align-items-center w-100'>
                                <div className='left'>
                                    ...
                                    <p>There are <span className='text-g'>{dataCart.length}</span> products in your cart</p>
                                </div>
                                                ...
                                                dataCart?.map((item, index) => {
                                                    return (
                                                        <tr>
                                                            ...
                                                            <td width="20%"><span>Rp.  {formatRibuan(parseInt(item.price.split(",").join("")))}</span></td>

                                                            <td>
                                                                <QuantityBox item={item} cartItems={dataCart} index={index} updateCart={updateCart} />
                                                            </td>

                                                            <td>
                                                                <span className='text-g'>Rp. {formatRibuan(parseInt(item.price.split(",").join("")) * parseInt(item.quantity))}</span>
                                                            </td>
                            ...
                            <div className='card p-4 '>
                                ...
                                <Link to={'/checkout'}>
                                    <Button className='btn-g btn-lg'
                                        onClick={() => {
                                            context.setCartTotalAmount(dataCart.length !== 0 &&
                                                dataCart.map(item => parseInt(item.price.split(",").join("")) * item.quantity).reduce((total, value) => total + value, 0))
                                        }}
